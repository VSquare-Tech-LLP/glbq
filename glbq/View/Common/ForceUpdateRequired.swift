        ...
        ZStack {
            ...
            VStack(spacing: ScaleUtility.scaledSpacing(20) ) {
                ...
                Image(systemName: "exclamationmark.triangle.fill")
                    .font(FontManager.generalSansRegularFont(size: .scaledFontSize(50)))
                    .foregroundColor(Color.red)
                    .padding(.top,  ScaleUtility.scaledSpacing(30))
                
                Text("Update Required")
                    .font(FontManager.generalSansBoldFont(size:.scaledFontSize(18)))
            ...
            .background(
                LinearGradient(
                    stops: [
                        ...
                        Gradient.Stop(color: Color(red: 0.9, green: 0.94, blue: 1), location: 1.00),
                    ],
