...
class UserSettings: ObservableObject {
    ...
    private struct Keys {
        ...
        static let dailyGeneratedImages = "dailyGeneratedImages"
        static let lastResetDate = "lastResetDate"
        static let extensionPurchasesToday = "extensionPurchasesToday"
    }
    ...
    @Published var dailyGeneratedImages: Int {
        didSet { defaults.set(dailyGeneratedImages, forKey: "dailyGeneratedImages") }
    }
    @Published var lastResetDate: Date {
        didSet { defaults.set(lastResetDate, forKey: "lastResetDate") }
    }
  
    @Published var extensionPurchasesToday: Int {
        didSet {
            defaults.set(extensionPurchasesToday, forKey: "extensionPurchasesToday")
        }
    }
    ...
    init() {
        ...
        self.dailyGeneratedImages = defaults.integer(forKey: Keys.dailyGeneratedImages)
        self.lastResetDate = defaults.object(forKey: Keys.lastResetDate) as? Date ?? Date()
        self.extensionPurchasesToday = defaults.integer(forKey: Keys.extensionPurchasesToday)
    ...
    func resetIfNeeded() {
        ...
        if !calendar.isDateInToday(lastResetDate) {
            dailyGeneratedImages = 0
            extensionPurchasesToday = 0
            lastResetDate = Date()
        }
    }
